...
class CompleteRequest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(CompleteRequestController());
                ...
                child: Row(
                  children: [
                    if (Navigator.of(context).canPop())
                      ...
                      // Provide a way to go back to home tab instead of a broken back button
                      IconButton(
                        icon: const Icon(Icons.home_outlined, color: Colors.white),
                        onPressed: () => Get.offAll(() => BottomNavbar(initialIndex: 0)),
                      ),
                     Expanded(
                      child: Center(
                        child: SmartText(
            ...
            child: Obx(() {
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8.h),
                      SmartText(
                        title: 'accepted_requests_here'.tr,
                        size: 14.sp,
              ...
              return RefreshIndicator(
                ...
                child: ListView.builder(
                  padding: EdgeInsets.only(top: 20.h, left: 16.w, right: 16.w, bottom: 30.h),
  ...
  Widget _buildRequestCard(
    ...
    CompleteRequestController controller,
  ) {
    return Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: ClipOval(
                      child: request['userProfileImage'] != null &&
                          ...
                          ? SecureFirebaseImage(
                              pathOrUrl: request['userProfileImage'],
                              fit: BoxFit.cover,
                              width: 60.r,
                              height: 60.r,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        SmartText(
                          title: request['userName'] ?? 'unknown_user'.tr,
                          size: 16.sp,
                          fontWeight: FontWeight.bold,
                        ),
                        Row(
              ...
              // Rating from Customer (if available)
                  ...
                  children: [
                    ...
                    Row(
                      children: List.generate(5, (index) {
                        return Icon(
                          index < (request['customerRating'] ?? 0)
                              ? Icons.star
                              : Icons.star_border,
                          color: Colors.amber,
                          size: 14.sp,
  ...
  void _showRequestDetails(
    ...
    // FIXED: Store the request docId to track updates
    final requestDocId = request['docId'];
    print('🔍 Opening request details for docId: $requestDocId');
    print('📋 Initial request data: ${request.toString()}');
    ...
    Get.bottomSheet(
      DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          // FIXED: Wrap in Obx to make it reactive
          return Obx(() {
            print('🔄 Obx rebuilding for docId: $requestDocId');

            // FIXED: Get updated request data from controller
            final updatedRequest = controller.completedRequests.firstWhere(
              (r) => r['docId'] == requestDocId,
              orElse: () {
                print(
                  '⚠️ Request not found in controller list, using original',
                );
                return request;
              },
            );

            print('📊 Updated request data: ${updatedRequest.toString()}');
            print(
              '🔑 providerRating value: ${updatedRequest['providerRating']}',
            );
            print(
              '🔑 providerReview value: ${updatedRequest['providerReview']}',
            );

            // FIXED: Check for providerRating in updated request
            final bool hasRated = updatedRequest['providerRating'] != null;
            ...
            return Container(
              ...
              child: ListView(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          ...
                          backgroundColor: Colors.grey[200],
                          child: ClipOval(
                            child: updatedRequest['userProfileImage'] != null &&
                                    updatedRequest['userProfileImage'].isNotEmpty
                                ? SecureFirebaseImage(
                                    pathOrUrl: updatedRequest['userProfileImage'],
                                    fit: BoxFit.cover,
                                    width: 70.r,
                                    height: 70.r,
                                    placeholder: (context, url) => const Center(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 4.w),
                                  Text(
                                    "${(updatedRequest['userRating'] ?? 0.0).round()} (${updatedRequest['totalRatings'] ?? 0} reviews)",
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.grey[700],
                  ...
                  if (updatedRequest['subcategory'] != null)
                    Builder(builder: (context) {
                      ...
                      if (updatedRequest['subcategory'] is List) {
                        subText =
                            (updatedRequest['subcategory'] as List).join(', ');
                      } else {
                  ...
                  // User Phone with Call & WhatsApp Icons
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      SmartText(
                        title: updatedRequest["userPhone"],
                        size: 14.sp,
                        fontWeight: FontWeight.bold,
                      ),
                      Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              final phone = updatedRequest["userPhone"];
                          ...
                          InkWell(
                            onTap: () async {
                              final phone = updatedRequest["userPhone"];
                              if (phone != null && phone.isNotEmpty) {
                                // Strip non-digit characters for WhatsApp deep link
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SmartText(
                                title:
                                    '${"accepted_by".tr}: ${updatedRequest['providerName']}',
                                size: 12.sp,
                                color: Colors.grey[700],
                              ),
                            ],
                  ...
                  // Show Rating FROM Customer (if available)
                  if (updatedRequest['customerRating'] != null) ...[
                    Container(
                      padding: EdgeInsets.all(16.w),
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: List.generate(5, (index) {
                              return Icon(
                                index < (updatedRequest['customerRating'] ?? 0)
                                    ? Icons.star
                                    : Icons.star_border,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: List.generate(5, (index) {
                              return Icon(
                                index < (updatedRequest['providerRating'] ?? 0)
                                    ? Icons.star
                                    : Icons.star_border,
                                color: Colors.amber,
                                size: 24.sp,
                  ...
                  // Rate Customer Button (only if not rated yet)
                  if (!hasRated) ...[
                    // Text(
                    //   '🔵 SHOWING RATE BUTTON - hasRated: $hasRated',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () =>
                            _showRatingBottomSheet(updatedRequest, controller),
                        icon: Icon(Icons.star, size: 20.sp),
                        label: SmartText(
                          title: 'rate_customer'.tr,
                          size: 16.sp,
                          fontWeight: FontWeight.bold,
                        ),
  ...
  void _showRatingBottomSheet(
    ...
    print('⭐ Opening rating bottom sheet');
    print('📝 Request docId: ${request['docId']}');
    print('👤 Customer userId: ${request['userId']}');
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SmartText(
                  title:
                      '${'how_was_your_experience'.tr} ${request['userName']}',
                  size: 14.sp,
                  color: Colors.grey[600],
                ),
                    ...
                    child: ElevatedButton(
                      onPressed: controller.isSubmittingRating.value
                          ...
                          : () {
                              ...
                              print('   - requestDocId: ${request['docId']}');
                              print('   - customerId: ${request['userId']}');
                              print('   - rating: ${selectedRating.value}');
                              print(
                                '   - review: ${reviewController.text.trim()}',
                              );

                              controller.submitCustomerRating(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SmartText(title: label, size: 12.sp, color: Colors.grey[600]),
