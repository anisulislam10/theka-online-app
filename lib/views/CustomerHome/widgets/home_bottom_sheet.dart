              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    Obx(() {
                      final isGuest = homeController.isGuestUser();
                      final isEnabled = isGuest || (
                        ...
                        onPressed: isEnabled
                            ? () {
                                ...
                                if (isGuest) {
                                  Get.dialog(
                                    AlertDialog(
                                      title: Text('guest_mode'.tr, style: TextStyle(fontWeight: FontWeight.bold)),
                                      content: Text('please_login_to_request'.tr),
